...
function hideBasedOnSelected(dropdownList){
     ...
     * @type {HTMLDivElement}
     */
    const parentElement = dropdownList.parentElement;
    ...
    makeVisibleBasedOnId(parentElement, value);
}
...
function hideBasedOnCheckbox(checkbox){
    ...
    makeVisibleBasedOnId(parentElement, isChecked ? "ferfi" : "no");
    makeInvisibleBasedOnid(parentElement, isChecked ? "no" : "ferfi")
}
